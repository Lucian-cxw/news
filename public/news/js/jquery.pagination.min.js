!function(t,a,e,i){
    ...
    n.prototype={
        ...
        render:function(){
            var t=this.opts,
            a=this.current,
            e=this.total,i=this.getPagesTpl(),
            ...
            getPagesTpl:function(){
                ...
                if(a<=n)for(g=1;g<=a;g++)i+=g===e?'<a href="javascript:void(0);" class="ui-pagination-page-item active" data-current="'+g+'">'+g+"</a>":'<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="'+g+'">'+g+"</a>";
                    ...
                    if(e<=s)for(g=1;g<=n;g++)i+=g===e?'<a href="javascript:void(0);" class="ui-pagination-page-item active" data-current="'+g+'">'+g+"</a>":'<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="'+g+'">'+g+"</a>";
                        ...
                        var r=Math.floor(s),h=e+r,o=e-r,c=n%2==0;h>a&&(c?(o-=h-a-1,h=a+1):(o-=h-a,h=a)),c||h++;for(var g=o;g<h;g++)i+=g===e?'<a href="javascript:void(0);" class="ui-pagination-page-item active" data-current="'+g+'">'+g+"</a>":'<a href="javascript:void(0);" class="ui-pagination-page-item" data-current="'+g+'">'+g+"</a>"
                    }
                }
                return i
            },
        ...
        t.fn.pagination=function(t,a,e){
            if("object"==typeof t){
                var i=new n(this,t);this.data("pagination",i)
            }
